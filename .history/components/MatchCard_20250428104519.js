...
export default function MatchCard({ match, onFollowTeam }) {
  const navigation = useNavigation();

  const handleFollow = (teamName) => {
    if (onFollowTeam) {
      onFollowTeam(teamName); // Call parent function
    }
  };
          ...
          <View style={styles.teamColumn}>
            ...
            <View style={styles.teamNameRow}>
              ...
              <TouchableOpacity onPress={() => handleFollow(match.teams.home.name)}>
                <Feather name="star" size={18} color="#666" style={styles.starIcon} />
              </TouchableOpacity>
            </View>
          </View>
