    ...
    <ScrollView style={styles.container}>
      ...
      {stats.length > 0 ? stats.map((teamStats, index) => (
        <View key={index} style={styles.card}>
          <Text style={styles.teamTitle}>{teamStats.team.name}</Text>
        ...
        <Text style={styles.empty}>No statistics available.</Text>
      )}
      ...
      {lineups.length > 0 ? lineups.map((teamLineup, index) => (
        <View key={index} style={styles.card}>
          <Text style={styles.teamTitle}>{teamLineup.team.name}</Text>
          <Text style={styles.detail}>Formation: {teamLineup.formation}</Text>
        ...
        <Text style={styles.empty}>No lineups available.</Text>
      )}
