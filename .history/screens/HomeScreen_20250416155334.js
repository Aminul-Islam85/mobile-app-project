...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* ✅ Hidden HTML5 date input for Web at the top-level */}
      {Platform.OS === 'web' && (
        <input
          ref={inputRef}
          type="date"
          ...
          onChange={(e) => {
            ...
            console.log('📅 Date selected via input:', selected);
  ...
  onPress={() => {
    if (Platform.OS === 'web') {
      console.log('🖱️ Web click triggered');
      if (inputRef.current) {
        console.log('📆 Input ref exists, triggering focus + click...');
        ...
        console.warn('⚠️ inputRef.current is null');
      }
    } else {
      console.log('📱 Mobile calendar triggered');
